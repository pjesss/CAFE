...
<body>
	<form action="FrontServlet?command=market_board_update" method="post" enctype="multipart/form-data" name="frm">
	<h1>수정하기</h1>
	<input type="hidden" name="userid" value="${loginUser.userid }">
	<input type="hidden" name="num" value="${vo.num }">
	<header class="header">
		<article class="article1">제목</article>
		<article class="article2"><input type="text" name="title" size="40" value="${vo.title }"></article>
	</header>

	<header class="header">
		<article class="article1">물품 이름</article>
		<article class="article2"><input type="text" name="goodsname" size="40" value="${vo.goodsname }"></article>
		<article class="article3">물품 가격</article>
		<article class="article4"><input type="text" name="goodsprice" value="${vo.goodsprice }"></article>
	</header>
	<header class="header">
	...
	<section class="section"><textarea rows="9" cols="95" name="content">${vo.content }</textarea></section>
